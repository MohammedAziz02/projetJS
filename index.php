    ...
    <body class="d-flex flex-column h-100">
        <main class="flex-shrink-0">
          ...
          <?php require_once "./src/Views/navbar.php"  ?>
                    ...
                    <div class="row gx-5 align-items-center">
                        <div class="col-xxl-5">
                            ...
                            <div class="text-center text-xxl-start">
                                <div class="badge bg-gradient-primary-to-secondary text-white mb-4"><div class="text-uppercase">Gestion de Club Bookidan Sport</div></div>
                                <!-- <div class="fs-3 fw-light text-muted">I can help your business to</div> -->
                                <h1 class="fw-bolder mb-5"><span class="text-gradient ">BienVenue à Votre Application</span></h1>
                        ...
                        <div class="col-xxl-7">
                            ...
                            <div class="d-flex justify-content-center mt-5 mt-xxl-0">
                                <div class="profile bg-gradient-primary-to-secondary">
                                    ...
                                    <img class="profile-img" src="./public/assets/acceuilimg.png" alt="..." />
                                    <div class="dots-1">
                                        <!-- SVG Dots-->
            ...
            <?php require_once "./src/Views/aboutus.php" ?>
        </main>
        <!-- Footer-->
